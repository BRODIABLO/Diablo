...
struct HotkeyConfig {
    bool enabled{};
    Hotkey hotkey{'S', InputDevice::Keyboard, false, false, false};
    std::string hotkeyText{"S"};
    bool consume{true};
};
